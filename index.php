    ...
    <div id="app">
        <div class="container-fluid p-4 w-75">
            <div class="gap-4 row justify-content-center">
                <div class="card p-2" v-for="(disk, index) in diskList" @click="albumClick(index)">
                ...
                <div class="card p-2" v-for="(myDisk, index) in myDiskList" @click="albumClickMyDisk(index)">
        ...
        <div class="overlay" v-if="showOverlay">
            ...
            <div class="card modal-card" v-if="selectedDisk">
